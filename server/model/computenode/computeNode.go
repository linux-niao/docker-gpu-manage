...
type ComputeNode struct {
  ...
  Cpu  *string `json:"cpu" form:"cpu" gorm:"comment:CPU信息;column:cpu;size:255;"`  //CPU
  Memory  *string `json:"memory" form:"memory" gorm:"comment:内存信息;column:memory;size:255;"`  //内存
  SystemDisk  *string `json:"systemDisk" form:"systemDisk" gorm:"comment:系统盘容量;column:system_disk;size:255;"`  //系统盘容量
  DataDisk  *string `json:"dataDisk" form:"dataDisk" gorm:"comment:数据盘容量;column:data_disk;size:255;"`  //数据盘容量
